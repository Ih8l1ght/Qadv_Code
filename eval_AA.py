...
if len(sys.argv) > 2:
    ...
    script_name = "qadv_trades_untarget"

# Set checkpoint path based on arguments
checkpoint_base = f'./Checkpoints/{run_name}/{script_name}'
epoch_range = range(72, 85)  
checkpoint_paths = [
...
output_dir = f'AutoAttack_Results/{run_name}/{script_name}'
os.makedirs(output_dir, exist_ok=True)

print(f"\n{'='*60}")
print(f"AutoAttack Evaluation Configuration")
print(f"{'='*60}")
print(f"Run name: {run_name}")
print(f"Script name: {script_name}")
print(f"Checkpoint directory: {checkpoint_base}")
print(f"Output directory: {output_dir}")
print(f"Epoch range: {min(epoch_range)} to {max(epoch_range)-1}")
print(f"{'='*60}\n")
...
def main():
    print("="*60)
    print(f"AutoAttack Evaluation - {run_name}/{script_name}")
    print("="*60)
